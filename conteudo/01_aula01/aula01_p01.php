                    ...
                    <div class="row">
                                            ...
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p>
                                                        ...
                                                        ransomware.
                                                        Esse tipo de ataque age
                                                        como
                                                        um “sequestrador virtual”, roubando arquivos e exigindo uma
                                                        quantia
                                                        em criptomoedas para a
                                                        liberação. A pasta não divulgou quais arquivos foram
                                                        criptografados.
                                                    </p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTE1NDk=/MTg2ODU="
                                                        class="carousel__link" target="_blank">G1</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p><strong>Um ataque na Renner</strong> derrubou os sistemas e o
                                                        site
                                                        oficial da rede. Os
                                                        criminosos
                                                        cobravam um resgate em torno de US$ 1 bilhão (R$ 5,24 bilhões)
                                                        para
                                                        liberar os sistemas
                                                        criptografados da empresa. De acordo com a rede varejista, a
                                                        maior
                                                        parte das operações foram
                                                        restabelecidas e o banco de dados foi preservado.</p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTIwNTE=/MTg2ODU="
                                                        class="carousel__link" target="_blank">Canaltech</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p><strong>O ataque hacker</strong> que derrubou o e-commerce da
                                                        Renner
                                                        acendeu um alerta para os
                                                        riscos da cibersegurança no Brasil e uma possível “pandemia” de
                                                        ransonware. Segundo a ISH
                                                        Tecnologia, 13 mil empresas são atacadas mensalmente, sendo 57%
                                                        com
                                                        ataques do tipo ransomware -
                                                        que pedem resgate em dinheiro às companhias. Em 2020, os valores
                                                        cobrados pelos criminosos
                                                        saltaram 82%, chegando a US$ 570 mil por ocorrência.</p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTIyMzg=/MTg2ODU="
                                                        class="carousel__link" target="_blank">Época Negócios</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p><strong>Os ataques hackers</strong> de grandes proporções
                                                        tornaram-se
                                                        uma ameaça para empresas
                                                        e
                                                        instituições governamentais no mundo inteiro. Segundo dados da
                                                        RiskIQ, empresa de cibersegurança
                                                        com sede em São Francisco, bastam 60 segundos para que empresas
                                                        de
                                                        todo o globo sofram 648
                                                        ameaças
                                                        hackers de qualquer tipo ou terem 525 mil dados comprometidos.
                                                    </p>
                                                    <p>Além disso, as companhias têm mais de US$ 1 milhão em perdas por
                                                        minuto devido aos incidentes
                                                        de
                                                        segurança. Ou seja, mitigar ciberataques custa tempo,
                                                        profissionais
                                                        especializados e dinheiro
                                                        para
                                                        as companhias. Por isso, conhecer as vulnerabilidades da sua
                                                        empresa
                                                        é fundamental para ficar à
                                                        frente das ameaças.</p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTI1NzY=/MTg2ODU="
                                                        class="carousel__link" target="_blank">RiskIQ</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            ...
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p><strong>Em mais um caso</strong> de vazamento de dados, o
                                                        Detran-SP
                                                        (Departamento Estadual de
                                                        Trânsito de São Paulo) sofreu um suposto ciberataque. Uma base
                                                        de
                                                        dados com 2 milhões de linhas
                                                        compostas por informações sensíveis de motoristas, como nome
                                                        completo, número do documento e
                                                        placa
                                                        do carro, foi colocada à venda no mercado ilegal.</p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTE2NDQ=/MTg2ODU="
                                                        class="carousel__link" target="_blank">TecMundo</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="carousel-caption d-flex align-items-center">
                                                <div class="d-md-block">
                                                    <p>Mais uma empresa de grande porte sofreu ataque hacker. Desta vez,
                                                        a
                                                        Accenture. Um grupo
                                                        conhecido
                                                        como LockBit teria obtido acesso a seis terabytes de arquivos da
                                                        companhia e exigido o pagamento
                                                        de US$ 50 bilhões em criptomoedas.</p>
                                                    <a href="https://apps.canalmeio.com.br/meio/news/r/OTEzNDY=/MTg2ODU="
                                                        class="carousel__link" target="_blank">Canaltech</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-2 d-flex align-items-center justify-content-center"><a href="#" type="button"
                                data-bs-target="#carouselCaptions" data-bs-slide="next" id="btnNext"><img
                                    src="../../img/seta_direita_ativa.png" alt="Próximo" class="img-fluid"></a></div>
                    </div>
                </section>
                <section id="mouse">
                    <div class="row">
