            ...
            $.getJSON('quiz.json', function(json) {
                ...
                Object.keys(json).forEach(function(quiz){                                                                           
                    ...
                    html+= `            </label>
                                ...
                                <div class="col-12 py-2 mt-4"> <a href="#" id="btnConferir_`+json[quiz].id+`" class="btn btn__primary text-center cyberpunk glitched">CONFERIR</a></div>
                                <div class="col-sm-8">`
                ...
                $("#btnConferir_quiz01").click(function (e) {
                    e.stopPropagation();
                    e.preventDefault();
                    ...
                    var selected = [];
                    selected[0]= $('#quiz01').attr('checked', true);
